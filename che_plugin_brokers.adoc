...
image::images/che-plugin-brokers/plugin_broker_lifecycle.png[width="1000", height="800",aption="Plugin Broker Lifecycle"]
...
More detailed flow is available in the following activity diagramm:
